...
def attack(char_name: str, char_class: str) -> str:
    """Implement a message about the damage done to the enemy.
...
def defence(char_name: str, char_class: str) -> str:
    """Implement a message about the amount of blocked damage.
...
def choice_char_class() -> str:
    """Implement сharacter Selection dialog.

    Returns:
        str: сharacter Selection
    """
    approve_choice: str = ''
    char_class: str = ''
